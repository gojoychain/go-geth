...
## Docker
For running a node with Docker, please visit our [ghu-deployer repo](https://github.com/ghuchain/ghu-deployer) which has all the setup needed to running a Docker node.
